...
contract ERC721Facet is IERC721, IERC721Enumerable {
     ...
     * while the token is not assigned a new owner, the `s.ownedTokensIndex` mapping is _not_ updated: this allows for
     * gas optimizations e.g. when performing a transfer operation (avoiding double writes).
     * This has O(1) time complexity, but alters the order of the s.ownedTokens array.
     * @param from address representing the previous owner of the given token ID
     ...
     * This has O(1) time complexity, but alters the order of the s.allTokens array.
